...
public class Department implements Serializable {
    ...
    @OperationLogAttr(attributeDes="部门ID")
    private Integer departmentId;

    @OperationLogAttr(attributeDes="部门名称")
    private String name;

    @OperationLogAttr(attributeDes="父级部门名称")
    private Integer pid;

    @OperationLogAttr(attributeDes="排序")
    private Integer seq;

    @OperationLogAttr(attributeDes="部门图标")
    private String icon;

    @OperationLogAttr(attributeDes="创建时间")
    private Date createTime;

    @OperationLogAttr(attributeDes="部门地址")
    private String address;

    @OperationLogAttr(attributeDes="部门编码")
    private String code;

    @OperationLogAttr(attributeDes="部门层级")
