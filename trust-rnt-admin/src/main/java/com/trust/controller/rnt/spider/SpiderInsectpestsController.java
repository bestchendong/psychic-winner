...
/**
 * @Author Yangcb
 * @Descrintion 爬虫库-病虫害管理
 * @Date create 2018-01-05 14:34
 * @Version 1.0
 */
@Controller
@RequestMapping("/rntadmin/spider/insectpests")
public class SpiderInsectpestsController extends BaseController {
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:insectpests:page")
    ...
    public String getArticleByPage(Model model, CmsArticleInfo cmsArticleInfo , @RequestParam(value = "pageNum", required = false,defaultValue = "1") Integer pageNum,
        ...
        return "/rnt/spider/insectpests/insectpests";
    }

    @RequiresPermissions("rntadmin:spider:insectpests:detail")
    ...
    public String getArticleDetail(Model model,@RequestParam("articleId")Long articleId){
        ...
        return "/rnt/spider/insectpests/detail";
    }

    @RequiresPermissions("rntadmin:spider:insectpests:delete")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:insectpests:batch;delete")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:insectpests:batch:release")
