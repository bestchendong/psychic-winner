 ...
 */
@Controller
@RequestMapping("/rntadmin/agriculturalnews")
public class AgriculturalNewsController extends BaseController {
    ...
    @RequiresPermissions("rntadmin:agriculturalnews:page")
    public String getArticleByPage(Model model, CmsArticleInfo cmsArticleInfo , @RequestParam(value = "pageNum", required = false,defaultValue = "1") Integer pageNum,
        ...
        return "/rnt/agriculturalnews/agriculturalnews";
    }
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:detail")
    ...
    public String getArticleDetail(Model model,@RequestParam("articleId")Long articleId){
        if(articleId!=null){
            ...
            model.addAttribute("agriculturalnews",cmsArticleInfo);
        }
        return "/rnt/agriculturalnews/detail";
    }
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:add")
    @RequestMapping(value = "/toadd",method = RequestMethod.GET)
    public  String  toAdd(){
        return "/rnt/agriculturalnews/add";
    }
    ...
    public  String  insertArticle(Model model, @ModelAttribute CmsArticleInfo cmsArticleInfo, HttpServletRequest request){
        ...
        return "redirect:/rntadmin/agriculturalnews/page";
    }
    /**
     *跳转添加页面
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:edit")
    ...
    public  String  toEdit(Model model,@RequestParam("articleId")Long articleId){
        ...
        return "/rnt/agriculturalnews/edit";
    }
    ...
    @RequiresPermissions("rntadmin:agriculturalnews:delete")
    @RequestMapping(value = "/delete",method = RequestMethod.POST)
    @ResponseBody
    public Result deleteContent(@RequestParam(value = "articleId",required =  true)Long articleId){
        try { return articleService.deleteArticle(articleId);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:batch:delete")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:batch:release")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:agriculturalnews:batch:undercarriage")
