...
/**
 * @Author Yangcb
 * @Descrintion 爬虫库-政策法规管理
 * @Date create 2018-01-05 14:34
 * @Version 1.0
 */
@Controller
@RequestMapping("/rntadmin/spider/regulations")
public class SpiderPoliciesRegulationsController extends BaseController {
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:regulations:page")
    ...
    public String getArticleByPage(Model model, CmsArticleInfo cmsArticleInfo , @RequestParam(value = "pageNum", required = false,defaultValue = "1") Integer pageNum,
        ...
        return "/rnt/spider/regulations/regulations";
    }
    @RequiresPermissions("rntadmin:spider:regulations:detail")
    ...
    public String getArticleDetail(Model model,@RequestParam("articleId")Long articleId){
        ...
        return "/rnt/spider/regulations/detail";
    }

    @RequiresPermissions("rntadmin:spider:regulations:delete")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:regulations:batch:delete")
     ...
     * @return
     */
    @RequiresPermissions("rntadmin:spider:regulations:batch:release")
