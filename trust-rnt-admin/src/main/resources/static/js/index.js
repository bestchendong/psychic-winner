$(document).ready(function () {
    ...
    for (var i = 0; i < data.length;i++){
        firMenu += '<li class="first-menu' + data[i].menuId + '" data-category="' + data[i].menuId + '"><a href="#"><img src="' + data[i].icon + '"/>' + data[i].name + '</a></li>';
    }
    ...
    $('.slideUl').on('click','li',function () {
        ...
        if (fourSpecial.length > 0){
            ...
            if(getPageUrl == "nopage"){
                $(".other-page").empty();
                $(".home-page").css('display','block');
            }else if(getPageUrl == null || getPageUrl == undefined || getPageUrl == ''){
                $(".other-page").html('<iframe src="/rntadmin/sys/readypage" frameborder="0" width="100%" height="100%"></iframe>')
            }else {
                $(".other-page").html('<iframe src="' + getPageUrl + '" frameborder="0" width="100%" height="100%"></iframe>')
            }
    ...
    $(".fourCtrol .fourMenu:nth-of-type(1) a").addClass("threeSelect");
    // $(".home_page").html('<iframe src="' + selectMenuC[0].url + '" frameborder="0" width="100%" height="100%"></iframe>')
});